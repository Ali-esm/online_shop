...
class SignUpForm(CustomUserCreationForm):
    ...
    password2 = forms.CharField(
        label="",
        widget=forms.PasswordInput(
            attrs={"class": "col-10 p-2", "placeholder": _("Confirm Password")}
        ),
    )
...
class LoginForm(AuthenticationForm):
    ...
    class Meta:
        ...
        error_messages = {"login_error": _("Phone Number or Password is Incorrect")}
        ...
        widgets = {
            ...
            "password": forms.PasswordInput(
                attrs={"class": "col-10 p-2", "placeholder": _("Password")}
            ),
        }
